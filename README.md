# Project 2 - *SimpleTweet2.0*

**SimpleTweet2.0* is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
<img src='https://github.com/MalcolmRDB/SimpleTweet2.0/blob/master/Tweet2.0.gif />
